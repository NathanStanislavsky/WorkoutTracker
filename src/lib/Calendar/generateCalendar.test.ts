...
describe("getNextMonth", () => {
  ...
  it('correctly return the next month and same year when current month is not December', () => {
    const result = getNextMonth(5, 2024); // June 2024
    expect(result).toEqual({ month: 6, year: 2024 }); // July 2024
  });
});
